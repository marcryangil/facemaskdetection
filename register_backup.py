...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_save = QtWidgets.QPushButton(self.frame, clicked= lambda: self.sample())
...
"}")
        ...
        self.btn_no_mask = QtWidgets.QPushButton(self.frame, clicked= lambda: self.sample())
...
"}")
        ...
        self.label_7.setGeometry(QtCore.QRect(70, 20, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Work Sans")
